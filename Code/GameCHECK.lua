...
local function printMemUsage()   	
   	...
   	localGroup:insert(memUsed)
   	local texUsed = system.getInfo( "textureMemoryUsed" ) / 1000000
   	localGroup:insert(texUsed)
...
toplight=display.newImage("toplight.png")
toplight1=display.newImage("toplight.png")
bag1=display.newImage("luggage1.png")
bag2=display.newImage("luggage2.png")
bag3=display.newImage("luggage3.png")
bag4=display.newImage("luggage4.png")
bag5=display.newImage("luggage5.png")
bag6=display.newImage("luggage6.png")
bag7=display.newImage("luggage7.png")
bag8=display.newImage("luggage8.png")
disp=display.newImage("displays.png")
clock=display.newImage("clock.png")
dog=display.newImage("doug.png")
